...
. Download minikube latest release: https://github.com/kubernetes/minikube/releases/latest
...
== 3.6 Deploy to Kubernetes using Standalone Single Manifest
...
== 3.7 Introduction to Helm Charts
...
== 3.8 Deploy Application to Kubernetes using Helm Charts
...
== 3.9 Debug Kubernetes Deployment using IntelliJ
